...
func runStatus(args []string) {
	...
	// ADR 0024 {working, blocked, idle} counts. dirSessionCounts folds the
	// retired dormant_n into idle for version-skew (an older daemon still sends
	// dormant_n; a new daemon sends 0) — shared with `info path:`.
