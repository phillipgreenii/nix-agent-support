# Decision docs — pg-router

The **decision docs** for pg-router: the durable _how_ that combines with its
[behavior docs](../behavior/README.md) to produce the product
...
area holds (a) content relocated out of pg-router's behavior docs and (b) entries pg-router's behavior
