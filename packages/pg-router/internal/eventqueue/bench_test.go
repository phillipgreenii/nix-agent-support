...
// here, and nothing here is asserted on by the pg-router-go-tests gate. Its
// purpose is feeding packages/pg-router/tests/perf-baselines.txt (Step 5) and
...
// packages/pg-router/tests/perf-baselines.txt's UNGATED baseline record.
