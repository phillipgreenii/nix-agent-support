...
// pg-router uses on both sides of a failure it itself schedules the retry for
...
// (`phillipgreenii-nix-agent-support · packages/pg-router/docs/decisions ·
...
// Default returns pg-router's chosen shape for an unconfigured handler retry
