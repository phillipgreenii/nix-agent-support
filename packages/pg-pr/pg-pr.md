...
> How pg-router orchestrates: see the [pg-router behavior docs](../pg-router/docs/behavior/README.md). The review/work **workflows** that use `pg-pr` are deployment-specific (defined in a deployment's own behavior docs). How they're implemented today: [`docs/pr-review-flow.md`](../../docs/pr-review-flow.md) (downstream reference).
