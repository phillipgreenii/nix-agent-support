...
The **decision docs** for pg-pr: the durable _how_ that combines with its
...
area holds (a) content relocated out of pg-pr's behavior docs and (b) entries pg-pr's behavior
