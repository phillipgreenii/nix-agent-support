...
// message regardless of the real cause (ported from pg-connector-pr-github,
// bead pg2-y23d4 #32).
...
// package strips from a child gh process (ported from pg-connector-pr-github,
// bead pg2-y23d4 #21):
//
...
//     override an explicit --repo a caller passes.
