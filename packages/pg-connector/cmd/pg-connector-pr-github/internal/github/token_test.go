...
// inherited GH_REPO overrides an explicit --repo a caller passes; and
// GH_CONFIG_DIR points gh at a different config/credential store. None of
// these were previously stripped.
...
// child either, for the same reason TestGHAuthTokenCommand_ExcludesLeakedGitDirFamily
// exists for the GIT_DIR family above.
