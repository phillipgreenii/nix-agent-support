...
// resolution) and has no remote-sync concept (GOAL-MIN-1). It is
...
// command doing both. Nothing in this file names a
...
// pkg/provider/scm.Provider's BranchDetect (interfaces.md's scm op catalog).
