...
| ------------- | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| `INV-SESS-1`  | the status surface carries a failure classification and diagnostic text alongside `errored` | the runtime already classifies a failing turn (transient / rate-limited / terminal) to drive its own in-place retry, and discards the classification once that retry path is exhausted — nothing persists it on the session record | bead filed at WS-3 landing (`pg2-wr6lm.6.2`) |
