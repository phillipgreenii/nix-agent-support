...
| `tui`                      | —                                                      | **Continuous-interactive** view: polls `status`'s activity ring and offers `pause`/`resume` from the same screen — the realization of exactly those two affordances (`interfaces.md`, "`tui` is not a sixth affordance"), never a third.                                                                                                                                                                                                                                                                                                                 |
...
`gate` is optional and defaults to `operator-paused`, same as the file-direct form; `resume`'s `all`
